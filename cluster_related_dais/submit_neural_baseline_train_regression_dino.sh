...
ARGS=( 
     ...
     experiment.group_name="fine_tune_resnet_for_all_ks_DINO_condition_Film_loss"
     experiment.checkpoint_path_best="neural_baseline/checkpoint/predict_recon_loss_condition_Film/dino_best.pt"
     experiment.checkpoint_path_latest="neural_baseline/checkpoint/predict_recon_loss_condition_Film/dino_latest.pt"
