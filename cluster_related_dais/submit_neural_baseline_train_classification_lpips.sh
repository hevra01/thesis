...
ARGS=( 
     ...
     experiment.group_name="lpips_all_finetune_resnet_filM_sigma${SIGMA}_extra_layer"
     
     experiment.checkpoint_path_best="neural_baseline/checkpoint/predict_token_count_filM/lpips_best_extra_layer.pt"
     experiment.checkpoint_path_latest="neural_baseline/checkpoint/predict_token_count_filM/lpips_latest_extra_layer.pt"
