...
# [1,2,4,8,16,32,64,128,256] for conditional but 0 for unconditional
  KEEP_K_LIST_RAW=${KEEP_K_LIST:-[32]}
else
...
OUTPUT_ROOT=/ptmp/hevrapetek/thesis/data/datasets/val_density_div_list_reconst_32/
...
ARGS+=(
  ...
  experiment.dataset.root=/ptmp/hevrapetek/reconstruction_imagenet_APC_true/val/reconst_32
