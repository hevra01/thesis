...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-estimate_density_RF_0_3}
...
ARGS=(
  ...
  experiment.output_path=/ptmp/hevrapetek/thesis/data/datasets/density_imagenet_val/corrected_hutchinson_4/token_count_4/
