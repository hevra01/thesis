...
OUTPUT_ROOT=/ptmp/hevrapetek/thesis/data/datasets/density_imagenet/train/reconst_64/
...
ARGS+=(
  ...
  experiment.dataset.root=/ptmp/hevrapetek/reconstruction_imagenet_APC_true/train/reconst_64
