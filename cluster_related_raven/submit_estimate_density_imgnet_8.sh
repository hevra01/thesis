...
OUTPUT_ROOT=/ptmp/hevrapetek/thesis/data/datasets/val_density_div_list_cond_uncond_reconst_64/
...
ARGS+=(
  ...
  experiment.dataset.root=/ptmp/hevrapetek/reconstruction_imagenet_APC_true/val/reconst_64
